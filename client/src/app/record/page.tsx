    ...
    return (
        <div className='dark:bg-stone-900 bg-gradient-to-r from-cyan-600 to-blue-500 bg-slate-100 relative h-screen w-screen overflow-clip'>
            ...
            <div className='h-full w-full absolute'>
                ...
                {!downloadUrl && <div className='m-5 max-sm:mx-3 rounded-xl h-[70%] mx-auto max-w-4xl bg-gradient-to-r from-indigo-500 to-stone-900 overflow-clip p-2 '>
                    <Player setStream={setStream} stream={stream} />
                </div>}

                {/* Download area */}
                {downloadUrl &&
                    <div className='flex gap-5 flex-wrap rounded-3xl md:p-4 m-5'>
                        <div className='max-w-3xl flex-grow my-4 h-auto min-h-fit'>
                            <video src={downloadUrl} autoPlay={true} controls />
                        </div>

                        <div className='w-full min-h-full flex flex-col max-w-xl mx-auto gap-4 items-center justify-center'>
                ...
                {/* Toolbar */}
                {
                    !downloadUrl && <div className='h-16 bg-white max-sm:mx-4 p-4 dark:bg-stone-800 m-4 rounded-xl max-w-4xl mx-auto text-5xl  shadow-3xl'>
                        <Tools
